...
{
public:
    RobotNewsStationNode() : Node("robot_news_station"), counter(0) {
        ...
        RCLCPP_INFO(this->get_logger(), "Robot NewsStation has been started!");
    }

private:
    void publishNews(){
        auto msg = example_interfaces::msg::String();
        msg.data = robot_name + " counter: " + std::to_string(counter) ;
